!function(){
	var bP={};	
	var b=30, bb=150, height=600, buffMargin=1, minHeight=15;
	var c1=[-160, 40], c2=[-52, 180], c3=[-13, 222]; //Column positions of labels.
	...
	function drawHeader(header, id){
		...
		[0,1].forEach(function(d){
			...
			h.append("text").text(header[d]).attr("x", (c1[d]-2))
				.attr("y", -5).style("fill","grey");
			
			h.append("text").text("Total Hits").attr("x", (c2[d]-15))
				.attr("y", -5).style("fill","grey");
